...
All four AMPL/Gurobi models solved to proven global optimality (nonconvex bilinear objectives, \texttt{nonconvex=2}) in well under a second on a standard laptop. Table~\ref{tab:miqp} summarizes the objective values and selected sets.
...
M1 MIQP + Comm & \texttt{10,\ 12,\ 15,\ 16,\ 17,\ 21,\ 26,\ 28,\ 29,\ 31,\ 32,\ 33,\ 37,\ 40,\ 41,\ 42,\ 44,\ 47,\ 48,\ 49,\ 51,\ 52,\ 53,\ 54,\ 59} & 13844.54 \\
M1 MIQP + Size & \texttt{10,\ 11,\ 12,\ 15,\ 16,\ 17,\ 20,\ 26,\ 27,\ 28,\ 29,\ 31,\ 32,\ 33,\ 36,\ 37,\ 40,\ 41,\ 44,\ 49,\ 51,\ 52,\ 53,\ 54,\ 59} & 58564.19 \\
M1 MIQP + Comm + Size & \texttt{10,\ 12,\ 15,\ 16,\ 17,\ 21,\ 26,\ 28,\ 29,\ 31,\ 32,\ 33,\ 37,\ 40,\ 41,\ 42,\ 44,\ 47,\ 49,\ 51,\ 52,\ 53,\ 54,\ 56,\ 59} & 56443.65 \\
\midrule
M2 Base MIQP & \texttt{10,\ 11,\ 12,\ 15,\ 16,\ 17,\ 20,\ 26,\ 27,\ 28,\ 29,\ 31,\ 32,\ 33,\ 36,\ 37,\ 40,\ 41,\ 44,\ 49,\ 51,\ 52,\ 53,\ 54,\ 59} & 16446.59 \\
M2 MIQP + Comm & \texttt{10,\ 11,\ 12,\ 15,\ 16,\ 17,\ 21,\ 27,\ 28,\ 29,\ 31,\ 32,\ 33,\ 36,\ 37,\ 40,\ 41,\ 42,\ 47,\ 49,\ 51,\ 52,\ 53,\ 56,\ 59} & 15218.16 \\
M2 MIQP + Size & \texttt{10,\ 11,\ 12,\ 15,\ 16,\ 17,\ 20,\ 26,\ 27,\ 28,\ 29,\ 31,\ 32,\ 33,\ 36,\ 37,\ 40,\ 41,\ 44,\ 49,\ 51,\ 52,\ 53,\ 54,\ 59} & 66552.23 \\
M2 MIQP + Comm + Size & \texttt{10,\ 11,\ 12,\ 15,\ 16,\ 21,\ 26,\ 27,\ 28,\ 29,\ 31,\ 32,\ 33,\ 36,\ 37,\ 40,\ 41,\ 42,\ 47,\ 48,\ 49,\ 51,\ 52,\ 53,\ 59} & 64448.16 \\
\bottomrule
\end{tabularx}
\end{table}
...
\midrule
Matrix 1 & \texttt{10, 15, 16, 17, 26, 28, 31, 32, 37, 40, 41, 44, 49, 51, 52, 53, 54} & 17 \\
Matrix 2 & \texttt{10, 11, 12, 15, 29, 31, 32, 36, 37, 40, 41, 49, 51, 52, 53} & 15 \\
\bottomrule
\end{tabular}
\end{table}

Matrix~1 has a $17$-site backbone and Matrix~2 a $15$-site backbone across the seven constant-forcing optimization runs.
...
\midrule
Intersection of M1 (17) and M2 (15) backbones & \texttt{10, 15, 31, 32, 37, 40, 41, 49, 51, 52, 53} & 11 \\
\bottomrule
\end{tabular}
\end{table}
...
These seven sites --- \textbf{10, 31, 37, 40, 41, 49, 53} --- appear in every greedy, every greedy+swap, every stingy, and every MIQP variant (base, +Comm, +Size, +Comm+Size) on both connectivity matrices and under both constant and realistic external forcing. They are the structural arteries of the bay's larval network: any restoration design that excludes them is structurally weaker. (The $18$ designs are the six constant-$P_0$ heuristics, the four realistic-$P_0$ heuristics reported in Table~\ref{tab:heur-real}, and the eight MIQP solves. Standalone greedy under realistic forcing is myopic and drops site $37$; it is used only as the seed for the realistic swap and is not counted among the $18$.)
...
\begin{itemize}[leftmargin=1.4em, itemsep=0.2em]
  \item \texttt{scripts/network\_core\_analysis.py} hard-codes a core-site list at the top. The validated constant-$P_0$ backbones from this re-analysis are: global $7$ sites (\texttt{10, 31, 37, 40, 41, 49, 53}), cross-matrix $11$ sites, and within-matrix $17$ (M1) and $15$ (M2). The hard-coded list should be regenerated from these. Note that site $47$ is selected by the heuristics but not by the base or +Size MIQP on either matrix, so it sits in the within-matrix backbones but not the cross-matrix one.
...
Across two independent connectivity matrices, four MIQP variants, three ODE-driven heuristics, and two external forcing regimes --- $18$ distinct optimization runs in total --- the same seven reefs are selected by every single one: $10, 31, 37, 40, 41, 49, 53$. The eleven-site cross-matrix constant-forcing backbone $\{10, 15, 31, 32, 37, 40, 41, 49, 51, 52, 53\}$ is the next natural layer out, and the per-matrix backbones ($17$ sites for Matrix~1, $15$ for Matrix~2) extend that further.
...
M1 MIQP + Comm & \texttt{10, 12, 15, 16, 17, 21, 26, 28, 29, 31, 32, 33, 37, 40, 41, 42, 44, 47, 48, 49, 51, 52, 53, 54, 59} \\
M1 MIQP + Size & \texttt{10, 11, 12, 15, 16, 17, 20, 26, 27, 28, 29, 31, 32, 33, 36, 37, 40, 41, 44, 49, 51, 52, 53, 54, 59} \\
M1 MIQP + Comm + Size & \texttt{10, 12, 15, 16, 17, 21, 26, 28, 29, 31, 32, 33, 37, 40, 41, 42, 44, 47, 49, 51, 52, 53, 54, 56, 59} \\
...
M2 MIQP + Comm & \texttt{10, 11, 12, 15, 16, 17, 21, 27, 28, 29, 31, 32, 33, 36, 37, 40, 41, 42, 47, 49, 51, 52, 53, 56, 59} \\
