# D:\NetworkAnalysisOysters\scripts\run_miqp_comm.py
...
def main():
    ...
    ampl.read(str(AMPL_DIR / "oyster_comm.mod"))     # uses set N, C1..C5
    ampl.readData(str(AMPL_DIR / "oyster_quad.dat")) # N, K, Pe, W
    ampl.readData(str(AMPL_DIR / "oyster_comm.dat")) # C1..C5
    ...
    out_csv = RUNS_DIR / "miqp_comm_sites.csv"
    pd.DataFrame(rows).to_csv(out_csv, index=False)

    out_txt = RUNS_DIR / "miqp_comm_summary.txt"
